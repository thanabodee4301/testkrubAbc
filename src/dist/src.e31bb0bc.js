...
var author$project$Main$init = {
	content: '',
	empty: elm$core$Array$fromList(_List_Nil)
};
	...
	function (msg, model) {
		if (msg.$ === 'SubmitText') {
			...
			return _Utils_update(
				model,
				{
					empty: A2(elm$core$Array$push, bank, model.empty)
				});
		} else {
			var bank = msg.a;
			return _Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('input someting'),
				...
				_List_fromArray(
					[
						...
						author$project$Main$SubmitText(model.content))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('กดดิวะ')
					])),
				A2(
				elm$html$Html$ul,
				_List_Nil,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"SubmitText":["String.String"],"Change":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"../../../../Users/itopplus/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/itopplus/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
